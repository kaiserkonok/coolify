        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <div class="w-full max-w-md space-y-8">
                ...
                <div class="space-y-6">
                    ...
                    @if ($is_oauth_only)
                        <div class="p-4 mb-4 bg-warning/10 border border-warning rounded-lg">
                            <p class="text-sm text-warning">Password registration is disabled. Please use OAuth to create an account.</p>
                        </div>
                    @endif
